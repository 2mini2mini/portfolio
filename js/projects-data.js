...
const PROJECTS_DATA = [
  {
    ...
    detail: {
      ...
      date: "2024 (4주 소요)",
      description:
        "<p><strong>실버에듀넷 회사 소개 사이트는 시니어 교육기관에 브랜드를 명확하고 신뢰감 있게 소개하기 위해 정보 구조와 페이지 흐름을 설계한 프로젝트입니다.</strong><br/>기관 담당자가 브랜드의 핵심 가치를 단계적으로 이해할 수 있도록 브랜드 소개 → 서비스 강점 → 신뢰 요소 순으로 구조를 구성하고, 메시지의 우선순위를 정리해 핵심 정보가 자연스럽게 강조되도록 설계했습니다. 또한 정보 밀도를 조절하고 여백을 확보해 안정적이고 정돈된 인상을 전달하는 데 집중했습니다.</p>" +
